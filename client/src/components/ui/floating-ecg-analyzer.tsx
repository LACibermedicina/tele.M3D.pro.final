        ...
        <Card className="flex flex-col h-full border-red-500/30 shadow-2xl bg-background/95 backdrop-blur-sm desktop-glass-panel">
          ...
          >
            ...
            <div className="flex items-center gap-0.5">
              ...
              <Button variant="ghost" size="icon" className="h-6 w-6 text-white/70 hover:text-white hover:bg-white/10" title="Minimizar" onClick={(e) => { e.stopPropagation(); setIsOpen(false); minimize({ id: 'floating-ecg', label: 'Análise ECG', icon: 'heart' }); }}>
